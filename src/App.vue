<template>
  <div class="header">
    <div class="icon-name-company">
      ...
      <div class="company">
        <h2 class="name-company">ТК «УралСбыт»</h2>
        <p class="info">Запчасти к а/м Урал</p>
      </div>
    </div>
    <div class="search">
    ...
    <div class="cart" style="margin-left: 20px;">
      <div>
        <h1><router-link to="/cart"><el-icon class="icon-cart" style="width: 40px;height: 35px;"><ShoppingCart/></el-icon></router-link></h1>
      </div>
    </div>
  </div>
    ...
    <div class="menu">
      <el-menu class="el-menu-demo" mode="horizontal">
        ...
        <el-sub-menu index="2">
          ...
          <el-menu-item index="2-2">Отзывы</el-menu-item>
